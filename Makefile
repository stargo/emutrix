...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Sun Aug 29 18:00:49 2010
# Project:  emutrix.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/emutrix0.1/ && $(COPY_FILE) --parents mainwindow.h sanealsa.h .tmp/emutrix0.1/ && $(COPY_FILE) --parents emutrix.qrc .tmp/emutrix0.1/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/emutrix0.1/ && $(COPY_FILE) --parents mainwindow.ui .tmp/emutrix0.1/ && (cd `dirname .tmp/emutrix0.1` && $(TAR) emutrix0.1.tar emutrix0.1 && $(COMPRESS) emutrix0.1.tar) && $(MOVE) `dirname .tmp/emutrix0.1`/emutrix0.1.tar.gz . && $(DEL_FILE) -r .tmp/emutrix0.1
