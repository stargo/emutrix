...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Sat Aug 28 15:26:25 2010
# Project:  emutrix.pro
# Template: app
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/emutrix1.0.0 || $(MKDIR) .tmp/emutrix1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/emutrix1.0.0/ && $(COPY_FILE) --parents mainwindow.h sanealsa.h .tmp/emutrix1.0.0/ && $(COPY_FILE) --parents emutrix.qrc .tmp/emutrix1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/emutrix1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/emutrix1.0.0/ && (cd `dirname .tmp/emutrix1.0.0` && $(TAR) emutrix1.0.0.tar emutrix1.0.0 && $(COMPRESS) emutrix1.0.0.tar) && $(MOVE) `dirname .tmp/emutrix1.0.0`/emutrix1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/emutrix1.0.0
