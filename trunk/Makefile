...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Aug 30 16:14:09 2010
# Project:  emutrix.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile emutrix.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DAPPLICATION_NAME=\"$(TARGET)\" -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
...
Makefile: emutrix.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix -o Makefile emutrix.pro
