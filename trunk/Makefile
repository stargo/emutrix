...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Mon Aug 30 13:09:13 2010
# Project:  emutrix.pro
# Template: app
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		mainwindow_slots.cpp moc_mainwindow.cpp \
		qrc_emutrix.cpp
OBJECTS       = main.o \
		mainwindow.o \
		mainwindow_slots.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/emutrix0.1/ && $(COPY_FILE) --parents sanealsa.h mainwindow.h .tmp/emutrix0.1/ && $(COPY_FILE) --parents emutrix.qrc .tmp/emutrix0.1/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp mainwindow_slots.cpp .tmp/emutrix0.1/ && $(COPY_FILE) --parents mainwindow.ui .tmp/emutrix0.1/ && (cd `dirname .tmp/emutrix0.1` && $(TAR) emutrix0.1.tar emutrix0.1 && $(COMPRESS) emutrix0.1.tar) && $(MOVE) `dirname .tmp/emutrix0.1`/emutrix0.1.tar.gz . && $(DEL_FILE) -r .tmp/emutrix0.1
...
qrc_emutrix.cpp: emutrix.qrc \
		...
		mute.png \
		link.png
	/usr/bin/rcc -name emutrix emutrix.qrc -o qrc_emutrix.cpp
