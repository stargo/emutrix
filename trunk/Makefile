...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Aug 30 15:22:00 2010
# Project:  emutrix.pro
# Template: app
...
SOURCES       = src/main.cpp \
		src/mainwindow.cpp \
		src/mainwindow_slots.cpp moc_mainwindow.cpp \
		qrc_emutrix.cpp
OBJECTS       = main.o \
		mainwindow.o \
		mainwindow_slots.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/emutrix0.1/ && $(COPY_FILE) --parents src/sanealsa.h src/mainwindow.h .tmp/emutrix0.1/ && $(COPY_FILE) --parents res/emutrix.qrc .tmp/emutrix0.1/ && $(COPY_FILE) --parents src/main.cpp src/mainwindow.cpp src/mainwindow_slots.cpp .tmp/emutrix0.1/ && $(COPY_FILE) --parents res/mainwindow.ui .tmp/emutrix0.1/ && (cd `dirname .tmp/emutrix0.1` && $(TAR) emutrix0.1.tar emutrix0.1 && $(COMPRESS) emutrix0.1.tar) && $(MOVE) `dirname .tmp/emutrix0.1`/emutrix0.1.tar.gz . && $(DEL_FILE) -r .tmp/emutrix0.1
...
mainwindow_slots.o: src/mainwindow_slots.cpp src/mainwindow.h \
		ui_setup.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindow_slots.o src/mainwindow_slots.cpp
